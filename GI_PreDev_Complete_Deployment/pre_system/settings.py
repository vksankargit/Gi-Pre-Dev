"""
Django settings for pre_system project.
"""
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.impersonation_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'pre_system.wsgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@pre-system.com')
